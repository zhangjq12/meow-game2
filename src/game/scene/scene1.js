...
export default class HelloWorldScene extends Phaser.Scene {
  ...
  update(time, delta) {
    ...
    this.lastfired = autoShoot(this.player, this.bullets, time, this.lastfired);
  ...
  createEmitter() {
    ...
    this.add
      ...
      .setScale(34);
    this.physics.world.setBounds(0, 0, 600, this.height);
    this.cameras.main.setBounds(0, 0, 600, this.height);
